...
We can see that the 2 graphs are not well separated and have significant overlap, which suggests thatt the discriminative power of the LDA model is limited.
