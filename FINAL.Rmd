...
We first plot the ROC curves of the models and compare the AUC values.
...
The logistic regression model with feature selection has the highest accuracy and the QDA model has the highest F1 score. In this case, since accuracy is the most important metric, the logistic regression model with feature selection is slightly better than the other models. The ROC curve shows that the logistic regression models have the highest AUC value. In conclusion, the logistic regression model with feature selection is the best model for predicting employee attrition.

This are the results balancing classes:
